...
--EG:
ALTER DATABASE BANKSMART SET OFFLINE WITH ROLLBACK IMMEDIATE;
...
--EG:
ALTER DATABASE BANKSMART SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
...
ALTER DATABASE BANKSMART SET MULTI_USER
...
--EG:
CREATE DATABASE BANKSMART ON 
(FILENAME = 'D:\DATA\BANKSMART.mdf'),
(FILENAME = 'D:\DATA\BANKSMART_log.LDF')
FOR ATTACH;
...
USE MASTER
CREATE DATABASE BANKSMART ON 
(FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\BANKSMART.mdf')
...
--EG:
ALTER DATABASE BANKSMART SET ONLINE;
